...
/*
	...
	Linux instructions:
	-	Compiled using gcc 3.3.5 (Debian 1:3.3.5-8ubuntu2).
	-	Also compiled with gcc 3.4.4 20050209 (prerelease) (Debian 3.4.3-9ubuntu4).
	-	Compile command: gcc main.cpp -lGL -lGLU -lglut -o frame_buffer
	-	Also see instructions at http://www.cacs.louisiana.edu/~cborst/gfxcourse

	Windows instructions:
	-	See instructions at http://www.cacs.louisiana.edu/~cborst/gfxcourse
*/
